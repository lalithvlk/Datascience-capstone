...
con1 <- file("C:/Users/lalithkumar.vemali/Documents/R/Data Capstone/Milestone/Data/Final/en_US/en_US.twitter.txt", open = "rb")
twitter <- readLines(con1, skipNul = TRUE, encoding="UTF-8")
close(con1)

con2 <- file("C:/Users/lalithkumar.vemali/Documents/R/Data Capstone/Milestone/Data/Final/en_US/en_US.news.txt", open = "rb")
news <- readLines(con2, skipNul = TRUE, encoding="UTF-8")
close(con2)

con3 <- file("C:/Users/lalithkumar.vemali/Documents/R/Data Capstone/Milestone/Data/Final/en_US/en_US.blogs.txt", open = "rb")
...
writeLines(SampleAll, "C:/Users/lalithkumar.vemali/Documents/R/coursera-data-science-capstone-master/data/sampleall/SampleAll.txt")
...
SampleAll <- VCorpus(DirSource("C:/Users/lalithkumar.vemali/Documents/R/coursera-data-science-capstone-master/data/sampleall", encoding = "UTF-8"))
...
quadgram <- read.csv("C:/Users/lalithkumar.vemali/Documents/R/coursera-data-science-capstone-master/ShinyApp/quadgram.csv",stringsAsFactors = F)
saveRDS(quadgram,"C:/Users/lalithkumar.vemali/Documents/R/coursera-data-science-capstone-master/data/ShinyApp/quadgram.RData")
...
write.csv(trigram[trigram$freq > 1,],"C:/Users/lalithkumar.vemali/Documents/R/coursera-data-science-capstone-master/ShinyApp/trigram.csv",row.names=F)
trigram <- read.csv("C:/Users/lalithkumar.vemali/Documents/R/coursera-data-science-capstone-master/ShinyApp/trigram.csv",stringsAsFactors = F)
saveRDS(trigram,"C:/Users/lalithkumar.vemali/Documents/R/coursera-data-science-capstone-master/ShinyApp/trigram.RData")
...
bigram <- read.csv("C:/Users/lalithkumar.vemali/Documents/R/coursera-data-science-capstone-master/ShinyApp/bigram.csv",stringsAsFactors = F)
saveRDS(bigram,"C:/Users/lalithkumar.vemali/Documents/R/coursera-data-science-capstone-master/ShinyApp/bigram.RData")
